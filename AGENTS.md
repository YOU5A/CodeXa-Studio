...
| 名称 | 用途 |
|------|------|
| useTheme | 主题读写 · updateSettings · resetSettings · toggleTheme · 8 套主题 + CSS 变量注入 |
...
- **Vite 8:** 端口 5173 · base: ./ · chunk 分包: react-vendor / motion-vendor / icons-vendor · 别名 @ → src/
- **TypeScript 6:** target ES2022 · bundler 解析 · strict 模式
